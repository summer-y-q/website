...
// variables
const entryObj = {};
const buildObj = require(path.join(__dirname, '../config', 'projectsInfo.json'));
const PACKAGE_JSON = require(path.join(__dirname, '../package.json'));
const ENV_OBJECT = { apiInfo: PACKAGE_JSON.apiInfo }
...
module.exports = (_env) => {
    ...
    return {
        ...
        plugins: process.env.NODE_ENV == "production" ? getPluginArray().concat([new UglifyJSPlugin()]) : getPluginArray(),
        resolve: {
...
function getPluginArray() {
    return [
        ...
        new webpack.DefinePlugin({
            ...
            API_INFO: JSON.stringify(ENV_OBJECT),
